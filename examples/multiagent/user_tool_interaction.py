...
from gem.multiagent.agents import ToolAgent, UserAgent, UserStrategy
        ...
        **kwargs,
        ...
        self.user_agent = UserAgent(
            ...
            script=(
                ...
                if user_strategy == UserStrategy.SCRIPTED
                else None
            ),
        )
        ...
        self.tool_agent = ToolAgent(
            agent_id="tool_agent", tools=mock_tools, strategy="react"
        )
...
def main():
    ...
    register(
        ...
        kwargs={"user_strategy": UserStrategy.SCRIPTED, "max_turns": 20},
    )
