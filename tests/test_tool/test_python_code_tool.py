...
def test_python(
    ...
    print(_send_test_request(url, action, "Python"))
...
def _send_test_request(url, action, test_name):
...
def main():
    ...
    Run with:
        python -m gem.tests.test_tool.test_python_code_tool python --url=http://localhost:5000/batch_execute_actions
    """
    fire.Fire({
        "python": test_python,
    })
